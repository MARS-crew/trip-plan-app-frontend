...
const ProfileEditScreen: React.FC = () => {
  ...
  const [country, setCountry] = React.useState('대한민국 / 서울');
  ...
  return (
    <SafeAreaView className="flex-1 bg-screenBackground" edges={['top']}>
      ...
      <ScrollView className="flex-1 px-4" showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 20 }}>
        <View className="mt-3 rounded-lg bg-white px-4 pb-5 pt-5" style={cardStyle}>
          <Text className="text-p1 font-semibold text-black">계정 정보</Text>
        ...
        <View className="mt-5 rounded-lg bg-white px-4 pb-5 pt-5" style={cardStyle}>
          <Text className="text-p1 font-semibold text-black">개인 정보</Text>
