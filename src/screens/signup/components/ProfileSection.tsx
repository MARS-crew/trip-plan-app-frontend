...
import type { ProfileSectionProps } from '@/types/signupProfile';
    ...
    <View className={`mt-5 ${showCountryPicker ? 'z-20' : ''}`}>
      <ContentContainer className="px-6 py-6">
        ...
        <View className="relative mb-4" onLayout={onCountryLayout}>
          ...
          {showCountryPicker && (
            <View className="h-34 absolute left-0 right-0 top-full z-50 mt-2 rounded-xl border border-borderGray bg-white">
